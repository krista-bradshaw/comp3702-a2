...
class Environment:
    ...
    def stoch_action(self, action):
        ...
        """
        # single move no drift 
        # single move drift left 
        # single move drift right 
        # double move no drift
        # double move drift left 
        # double move drift right
        dbl = self.double_move_probs[action]
        cw = self.drift_cw_probs[action]
        ccw = self.drift_ccw_probs[action]
